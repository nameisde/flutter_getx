...
import 'package:flutter_getx/05%20getx_statemanagement/getx_statemanagement_reactive_controller_type/reactive_controller_type_controller.dart';
import 'package:get/get.dart';

class GetXStateManagementReactiveControllerType extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('GetX Statemanagement Reactive Controller Type'),
      ),
      body: Center(
        child: Column(
          ...
          children: [
            GetX<MyController>(
              ...
              /// -- init pada GetX<Tyoe of Controller> digunakan
